...
const TodoContainer = () => {
    ...
    const todoData2:TTodoCardProps[] = todos
    if (isLoading) {
        return <div className="flex justify-center items-center h-screen">
        <svg aria-hidden="true" className="size-20 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <section>
            ...
            <div className="border-[5px] border-purple-600 w-full h-full rounded-xl p-5 space-y-4">
                ...
                {todoData2 ?
                    todoData2?.map(item=> <TodoCard key={item.id} {...item}></TodoCard>
                    ) : <p className="flex justify-center items-center text-2xl font-bold bg-white rounded-md">There is no task pending</p>
                }
            </div>
        </section>
